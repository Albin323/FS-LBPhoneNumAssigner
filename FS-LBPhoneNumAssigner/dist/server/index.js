...
on("playerConnecting", async (name, _setKickReason, deferrals) => {
  deferrals.defer();
  const src = source;
  ...
  try {
    await import_oxmysql.oxmysql.insert("INSERT IGNORE INTO phone_phones (id, owner_id, phone_number) VALUES (?, ?, ?)", [
      license,
      license,
      phoneNumber
    ]);
